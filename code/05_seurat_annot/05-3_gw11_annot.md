...
```
    ...
    ## 23:00:42 UMAP embedding parameters a = 0.9922 b = 1.112

    ## 23:00:42 Read 15994 rows and found 204 numeric columns

    ## 23:00:42 Using Annoy for neighbor search, n_neighbors = 30

    ## 23:00:42 Building Annoy index with metric = cosine, n_trees = 50
    ...
    ## **************************************************|
    ## 23:00:48 Writing NN index file to temp file /tmp/RtmpQJoOfj/file13ff174310a0
    ## 23:00:48 Searching Annoy index using 1 thread, search_k = 3000
    ## 23:01:02 Annoy recall = 100%
    ## 23:01:02 Commencing smooth kNN distance calibration using 1 thread with target n_neighbors = 30
    ## 23:01:03 Initializing from normalized Laplacian + noise (using irlba)
    ## 23:01:04 Commencing optimization for 200 epochs, with 779896 positive edges
    ## 23:01:15 Optimization finished
...
``` r
new.label <- c(
  "Excitatory", "NPC", "Unclassifiable", "MGE", "LGE", "NPC",
